...
/// EDITED BY CARTER - just changed the names to put them all in one .c file
...
static const double xgk31[16] =   /* abscissae of the 31-point kronrod rule */
{
...
static const double wg31[8] =     /* weights of the 15-point gauss rule */
{
...
static const double wgk31[16] =   /* weights of the 31-point kronrod rule */
{
      ...
      double *resabs, double *resasc)
{
  ...
  gsl_integration_qk (16, xgk31, wg31, wgk31, fv1, fv2, f, a, b, result, abserr, resabs, resasc);
}

/// PULLED FROM qk41.c

static const double xgk41[21] =   /* abscissae of the 41-point kronrod rule */
{
...
static const double wg41[11] =    /* weights of the 20-point gauss rule */
{
...
static const double wgk41[21] =   /* weights of the 41-point kronrod rule */
{
                      ...
                      double *resabs, double *resasc)
{
  ...
  gsl_integration_qk (21, xgk41, wg41, wgk41, fv1, fv2, f, a, b, result, abserr, resabs, resasc);
}

/// PULLED FROM qk51.c

static const double xgk51[26] =   /* abscissae of the 51-point kronrod rule */
{
...
static const double wg51[13] =    /* weights of the 25-point gauss rule */
{
...
static const double wgk51[26] =   /* weights of the 51-point kronrod rule */
{
                      ...
                      double *resabs, double *resasc)
{
  ...
  gsl_integration_qk (26, xgk51, wg51, wgk51, fv1, fv2, f, a, b, result, abserr, resabs, resasc);
}

/// PULLED FROM qk61.c

static const double xgk61[31] =   /* abscissae of the 61-point kronrod rule */
{
...
static const double wg61[15] =    /* weights of the 30-point gauss rule */
{
...
static const double wgk61[31] =   /* weights of the 61-point kronrod rule */
{
